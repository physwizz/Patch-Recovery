...
# How to use:
- Fork this repo.
- Extract your recovery.img.lz4 and upload recovery.img or *img.lz4 to bashupload nextcloud https://filebin.net/ or any other file hosting sites. Once uploaded right click on the Download button and copy the URL.
